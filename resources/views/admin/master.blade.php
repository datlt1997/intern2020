...
<head>
  ...
  <!-- bootstrap slider -->
  <link rel="stylesheet" href="{{asset('css/plugins/seiyria-bootstrap-slider/css/bootstrap-slider.min.css')}}">
  <!-- Theme style -->
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <nav class="navbar navbar-static-top">
        ...
        <a href="{{route('change-language', config('constant.english')) }}"><img src="{{asset('image/flag/english.png')}}" alt="english flag" style="width: 30px; transform: translateY(10px)"></a>
        <a href="{{ route('change-language', config('constant.vietnam')) }}"><img src="{{asset('image/flag/vietnam.png')}}" alt="vietnam flag" style="width: 30px; transform: translateY(10px)"></a>
      </nav>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="treeview">
            <a href="#">
              <i class="fa fa-dashboard"></i> <span>{{ __('message.dashboard') }}</span>
 ...
 <!-- Bootstrap slider -->
 <script src="{{asset('js/plugins/seiyria-bootstrap-slider/bootstrap-slider.min.js')}}"></script>
 <script>
  $(function () {
    /* BOOTSTRAP SLIDER */
    $('.slider').slider()
